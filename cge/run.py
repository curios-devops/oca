"""Run every registered mesh version through every gate and print one table.
    ...
    python -m cge.run                       # all versions, all gates, 1 seed
    python -m cge.run --seeds 0 1 2         # with error bars
    python -m cge.run --gates maze --sides 12 24   # the scale stress
