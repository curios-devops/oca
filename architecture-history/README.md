...
| **Jay** — OCA v5, build `jay-v5.1` | live, untagged, **no accepted L1** | [docs/jay/](../docs/jay/) |
...
| **Tower, feature-at-place binding (L1)** | Jay, `v5.1` | 2026-07-31 | [JAY_L1_BINDING.md](JAY_L1_BINDING.md) |
