...
This is what makes one contract (`dcn/contract.py`) and one benchmark sufficient for all of
...
[SPEC_SB1.md](../RPDU/SPEC_SB1.md) for the full description — the cycle is architecture-
