...
probes, metrics and baselines; `bench/` holds the registry and the gates; `tests/` holds
the battery. A DCN registers in `bench/registry.py` with four methods and is then scored
