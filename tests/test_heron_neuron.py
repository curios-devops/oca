...
from cge.components import (_delta_events, gate_rate_distortion, nrmse,
                              summarise_rate_distortion, zero_order_hold)
from architectures.heron.neuron import NeuronConfig, build_population, dense, received, step
...
def test_threshold_solver_hits_the_requested_rate():
    ...
    for target in (0.1, 0.3):
        from cge.components import policy_send_on_delta
